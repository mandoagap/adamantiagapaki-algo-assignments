...
def tiling(n, x, y, a, b, i, colors):
    ...
    # Recursion
    if x-a < n//2 and y-b < n//2:
        tiling(n//2, x, y, a, b, i, colors)
        tiling(n//2, a+n//2, b+n//2-1, a+n//2, b, i, colors)
        tiling(n//2, a+n//2, b+n//2, a+n//2, b+n//2, i, colors)
        tiling(n//2, a+n//2-1, b+n//2, a, b+n//2, i, colors)
    if x-a >= n//2 and y-b < n//2:
        tiling(n//2, a+n//2-1, b+n//2-1, a, b, i, colors)
        tiling(n//2, x, y, a+n//2, b, i, colors)
        tiling(n//2, a+n//2, b+n//2, a+n//2, b+n//2, i, colors)
        tiling(n//2, a+n//2-1, b+n//2, a, b+n//2, i, colors)
    if x-a >= n//2 and y-b >= n//2:
        tiling(n//2, a+n//2-1, b+n//2-1, a, b, i, colors)
        tiling(n//2, a+n//2, b+n//2-1, a+n//2, b, i, colors)
        tiling(n//2, x, y, a+n//2, b+n//2, i, colors)
        tiling(n//2, a+n//2-1, b+n//2, a, b+n//2, i, colors)
    if x-a < n//2 and y-b >= n//2:
        tiling(n//2, a+n//2-1, b+n//2-1, a, b, i, colors)
        tiling(n//2, a+n//2, b+n//2-1, a+n//2, b, i, colors)
        tiling(n//2, a+n//2, b+n//2, a+n//2, b+n//2, i, colors)
        tiling(n//2, x, y, a, b+n//2, i, colors)
...
# Call fitst time the recursive backtracking function
tiling(N, X, Y, 0, 0, 0, {})
print("Final : ")
show()